...
const Card = (props) => {
  ...
  return (
    <div className="w-48 overflow-hidden bg-mist-200 rounded-2xl shadow-lg bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl dark:bg-slate-800">
